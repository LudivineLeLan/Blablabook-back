...
// ----- Genre & Book -----
Genre.belongsToMany(Book, { through: "belongs_to", foreignKey: "genre_id", otherKey: "book_id", as: "books" });
Book.belongsToMany(Genre, { through: "belongs_to", foreignKey: "book_id", otherKey: "genre_id", as: "genres" });

// ----- Author & Book -----
Author.belongsToMany(Book, { through: "written_by", foreignKey: "author_id", otherKey: "book_id", as: "books" });
Book.belongsToMany(Author, { through: "written_by", foreignKey: "book_id", otherKey: "author_id", as: "authors" });
